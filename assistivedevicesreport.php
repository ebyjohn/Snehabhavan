...
$countSql = "SELECT COUNT(*) AS AssistiveDevicesCount FROM participantdetails WHERE AssistiveDevices = 'YES'";
$countResult = mysqli_query($conn, $countSql);
$AssistiveDevicesCount = mysqli_fetch_assoc($countResult)["AssistiveDevicesCount"];


$detailsSql = "SELECT * FROM participantdetails WHERE AssistiveDevices = 'YES'";
...
<a href="reports.php" class="backtoreports-button">REPORTS</a>
    <div class="card">
        <h2 class="card-title">Total Children with Assistive Devices</h2>
        <h3 style="text-align: center;"><?php echo $AssistiveDevicesCount; ?></h3>
        ...
        <a href="22download.php" class="download-button">Download</a>
    </div>
</body>
</html>
