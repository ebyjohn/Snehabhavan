...
$countSql = "SELECT COUNT(*) AS SchoolCount 
FROM participantdetails 
WHERE (EducationLevel = 'Primary School or Elementary School' OR EducationLevel = 'Secondary School or High School')";
$countResult = mysqli_query($conn, $countSql);
$SchoolCount = mysqli_fetch_assoc($countResult)["SchoolCount"];


$detailsSql = "SELECT * FROM participantdetails WHERE (EducationLevel = 'Primary School or Elementary School' or EducationLevel ='Secondary School or High School')";
...
<a href="reports.php" class="backtoreports-button">REPORTS</a>
    <div class="card">
        <h2 class="card-title">Total Children Attending Schools</h2>
        <h3 style="text-align: center;"><?php echo $SchoolCount; ?></h3>
        ...
        <a href="23download.php" class="download-button">Download</a>
    </div>
</body>
</html>
