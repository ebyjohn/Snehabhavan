...
$countSql = "SELECT COUNT(*) AS Count FROM participantdetails WHERE EmployableSkills = 'Yes'";
$countResult = mysqli_query($conn, $countSql);
$Count = mysqli_fetch_assoc($countResult)["Count"];


$detailsSql = "SELECT * FROM participantdetails WHERE EmployableSkills = 'Yes'";
...
<a href="reports.php" class="backtoreports-button">REPORTS</a>
    <div class="card">
        <h2 class="card-title">Total  Parents Willing To Send Their Children For Employable Skills Development</h2>
        ...
        <a href="25download.php" class="download-button">Download</a>
    </div>
</body>
</html>
