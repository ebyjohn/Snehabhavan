...
<body>
        ...
        <div class="table-wrapper">
            <table class="data-table">
                ...
                <tbody>
                    ...
                    $sql = "SELECT DisabilityType, GROUP_CONCAT(DISTINCT FatherEducation SEPARATOR '<br>') AS FatherEducations
                    ...
                    if (mysqli_num_rows($result) > 0) {
                        while ($row = mysqli_fetch_assoc($result)) {
                            ...
                            echo '<td>' . $row['FatherEducations'] . '</td>';
                            echo '</tr>';
                        }
                    } else {
                        echo '<tr>';
    ...
    <a href="fathereducationdisabilitywise.php" class="download-button">Download</a>
