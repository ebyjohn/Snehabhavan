...
<body>
        ...
        <div class="table-wrapper">
            <table class="data-table">
                ...
                <tbody>
                    ...
                    $sql = "SELECT DisabilityType, GROUP_CONCAT(DISTINCT MotherOccupation SEPARATOR '<br>') AS MotherOccupations
                    ...
                    if (mysqli_num_rows($result) > 0) {
                        while ($row = mysqli_fetch_assoc($result)) {
                            ...
                            echo '<td>' . $row['MotherOccupations'] . '</td>';
                            echo '</tr>';
                        }
                    } else {
                        echo '<tr>';
    ...
    <a href="fatheroccupationdisabilitywise.php" class="download-button">Download</a>
