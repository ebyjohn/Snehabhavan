...
--
-- Host: 127.0.0.1
-- Generation Time: Jul 10, 2023 at 07:48 PM
...
CREATE TABLE `participantdetails` (
  ...
  `LandOwnershipDetails` text DEFAULT NULL,
  `HouseDetails` text DEFAULT NULL,
...
INSERT INTO `participantdetails` (`ParticipantID`, `Name`, `Age`, `Gender`, `panchayat`, `taluk`, `ward`, `EducationLevel`, `VocationalTraining`, `Address`, `PhoneNumber`, `Email`, `BirthCertificate`, `DisabilityCertificate`, `Udid`, `AadharCardNumber`, `ElectionID`, `RationCard`, `OtherIdentity`, `Pension`, `Scholarship`, `HealthInsurance`, `Asraya`, `KSRTCConcession`, `PrivateBusConcession`, `RailwayConcession`, `Aswasakiran`, `OtherBenefits`, `Membership`, `BankAccountType`, `BankDetails`, `DisabilityType`, `AgeOfOnset`, `Severity`, `Duration`, `EmploymentStatus`, `MonthlyIncome`, `TypeOfWork`, `RegisteredWithEmploymentExchange`, `HealthcareCoverageSource`, `MonthlyHealthcareExpenses`, `HealthcareServicesUsed`, `HousingType`, `MonthlyHousingCosts`, `FatherName`, `MotherName`, `SiblingName`, `FatherAge`, `MotherAge`, `SiblingAge`, `FatherEducation`, `MotherEducation`, `SiblingEducation`, `FatherOccupation`, `MotherOccupation`, `SiblingOccupation`, `FatherSalary`, `MotherSalary`, `SiblingSalary`, `IncomeLevel`, `RationCardType`, `LandOwnershipDetails`, `HouseDetails`, `WaterSource`, `CookingFuelSource`, `ToiletType`, `Transportation`) VALUES
(0, '', 0, 'Male', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', 0, 0, 0, 0, 0, 0, 0, 0, '', '', 'own', '', '', 0, '', '', '', 0, '', 0, '', '0.00', '', '', 0, '', '', '', 0, 0, 0, '', '', '', '', '', '', 0, 0, 0, '0.00', '', '', '', '', '', '', ''),
(31, 'Eby John', 0, 'Male', '', '', '', '', '', 'Vadasseri house, kuttiattu junction, cherthala.', '', '', '', '', '', '', '', '', '', 0, 0, 0, 0, 0, 0, 0, 0, '', '', 'own', '', 'gay', 0, '', '', 'soon', 0, '', 0, 'kallapanam', '0.00', '', 'houseboat', 0, '', '', '', 0, 0, 0, '', '', '', '', '', '', 0, 0, 0, '0.00', '', '', '', '', '', '', '');
