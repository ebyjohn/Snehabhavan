...
<html>
<head>
    <title>Age-wise Distribution of Different Disabilities</title>
    <style>
        body {
...
<div class="form-container">
    <form method="POST" action="">
        ...
        <input type="number" name="age" id="age" placeholder="E.g., 10">
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    // Prepare and execute the query with the selected age value
    $sql = "SELECT * FROM participantdetails WHERE Age = '$selectedAge'";
    $result = mysqli_query($conn, $sql);

    $totalPeople = mysqli_num_rows($result); // Get the total number of people in that age
    ...
    if ($totalPeople > 0) {
        ...
        echo '<a href="9download.php" class="download-button" style="margin-right: 10px;">Download</a>';
