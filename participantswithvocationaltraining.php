...
$countSql = "SELECT COUNT(*) AS vocational_count FROM participantdetails WHERE VocationalTraining = 'YES' AND Age <= 18";
$countResult = mysqli_query($conn, $countSql);
$vocationalCount = mysqli_fetch_assoc($countResult)["vocational_count"];

// Query to fetch children with vocational training
$detailsSql = "SELECT * FROM participantdetails WHERE VocationalTraining = 'YES' AND Age <= 18";
...
<a href="reports.php" class="backtoreports-button">REPORTS</a>
    <div class="card">
        <h2 class="card-title">Total Children with Vocational Training</h2>
        <h3 style="text-align: center;"><?php echo $vocationalCount; ?></h3>
