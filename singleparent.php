...
<body>
        ...
        <div class="table-wrapper">
            <table class="data-table">
                ...
                <tbody>
                    ...
                    // Prepare and execute the query to fetch single parents with disabled children and their disability types
                    $sql = "SELECT CASE
                    WHEN FatherName <> '' THEN FatherName
                    WHEN MotherName <> '' THEN MotherName
                END AS ParentName,
                Name AS DisabledChild,
                DisabilityType
         FROM participantdetails
         WHERE (FatherName <> '' AND MotherName = '') OR (FatherName = '' AND MotherName <> '')";
    ...
    <a href="singleparent.php" class="download-button">Download</a>
