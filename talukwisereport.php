...
if ($_SERVER["REQUEST_METHOD"] === "POST") {
    ...
    $inputTaluk = $_POST["taluk"];
    $_SESSION['taluk']=$inputTaluk;
    ...
    if (mysqli_num_rows($result) > 0) {
        ...
        echo '</div>';
        echo '</div>';
        echo '<a href="3download.php" class="download-button" style="margin-right: 10px;">Download</a>';
...
<form method="POST" action="<?php echo $_SERVER['PHP_SELF']; ?>">
    <label for="taluk">Enter Taluk:</label>
