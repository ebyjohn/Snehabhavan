...
if ($_SERVER["REQUEST_METHOD"] === "POST") {
    ...
    $sql = "SELECT ward, COUNT(*) AS family_count FROM participantdetails WHERE panchayat = '$inputPanchayat' GROUP BY ward";
...
<div class="container">
    <h2>Ward-wise Number of Families</h2>
  ...
  <option value="Vijayapuram Grama Panchayat">Vijayapuram Grama Panchayat</option>
    ...
    <?php endif; ?>
    <?php echo '<a href="4download.php" class="download-button" style="margin-right: 10px;">Download</a>';?>
